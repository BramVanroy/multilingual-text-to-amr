...
and add `:sense` for generalizability. That means the model can still generate `:sense200` with multiple tokens. Note
that counting is with a prepended zero for `< 10`. E.g. `:sense07`.
